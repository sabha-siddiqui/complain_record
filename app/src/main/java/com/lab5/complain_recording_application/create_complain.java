    ...
    public void saveComplain(View view) {
        ...
        if (comp_id.isEmpty() || category.isEmpty() || severity.isEmpty() || description.isEmpty()) {
            ...
            if (seccess_comp_insert == true) {
                ...
                Intent in = new Intent(create_complain.this, view_complains.class);
                startActivity(in);
            }
        }
    }
